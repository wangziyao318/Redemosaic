...
classifiers = [
    ...
    SVC(kernel="linear", C=0.025, random_state=rdm_state),
    SVC(gamma=2, C=1, random_state=rdm_state),
    GaussianProcessClassifier(1.0 * RBF(1.0), random_state=rdm_state),
    DecisionTreeClassifier(max_depth=5, random_state=rdm_state),
    RandomForestClassifier(
        max_depth=5, n_estimators=10, max_features=1, random_state=rdm_state
    ),
    MLPClassifier(alpha=1, max_iter=1000, random_state=rdm_state),
    AdaBoostClassifier(algorithm="SAMME", random_state=rdm_state),
    GaussianNB(),
    QuadraticDiscriminantAnalysis(),
    LogisticRegression(multi_class="multinomial", max_iter=1000, random_state=rdm_state),
]
